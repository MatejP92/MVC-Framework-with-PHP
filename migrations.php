...
$app = new Application(__DIR__, $config);       // if we didnt have the use matejpal\phpmvc\application above, we would always need to write new matejpal\phpmvc\Application() if we want to create a new instance of the Application
