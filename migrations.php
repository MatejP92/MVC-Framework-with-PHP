...
$app = new Application(__DIR__, $config);       // if we didnt have the use app\core\application above, we would always need to write new app\core\Application() if we want to create a new instance of the Application
